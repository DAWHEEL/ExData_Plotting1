...
#Create png
png(file = "plot2.png", width = 480, height = 480, antialias = "cleartype")  
par(mar= c(4, 4, 2, 1))

#Implement the plot  
with(consump_range,plot(x = DateTime, y = Global_active_power, xlab = "", ylab = "Global Active Power (kilowatts)", main = NULL, col = "black",type = "l"))  
dev.off() 
